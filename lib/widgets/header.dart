  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      if (isDesktop) {
        ...
        final anilistAuth = Get.isRegistered<AnilistAuth>()
        ...
        final content = Row(
          children: [
            ...
            const Spacer(),
            if (type == PageType.home && anilistAuth != null)
              Obx(() {
                ...
                return Row(
                  ...
                  children: [
                    _HeaderQuickButton(
                      ...
                      onTap: () => navigate(() => const AnimeList()),
                      context: context,
                    ),
                    const SizedBox(width: 6),
                    _HeaderQuickButton(
                      icon: Icons.menu_book_rounded,
                      onTap: () => navigate(() => const AnilistMangaList()),
                      context: context,
                    ),
                    const SizedBox(width: 6),
                    _HeaderQuickButton(
                      icon: Icons.apps_rounded,
                      onTap: () => navigate(() => const OtherFeaturesPage()),
                      context: context,
                    ),
                  ],
                );
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        height: 30,
        decoration: BoxDecoration(
          color: context.colors.primaryContainer.withOpacity(0.35),
