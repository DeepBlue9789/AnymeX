...
class _MediaPeekPopupState extends State<MediaPeekPopup> {
          ...
          child: Column(
            ...
            children: [
              ...
              if (widget.media.romajiTitle.isNotEmpty &&
                ...
                AnymeXText(widget.media.romajiTitle,
              ...
              child: _DetailsStyleButton(
                ...
                child: Obx(() => Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Flexible(
                          child: AnymeXText(convertAniListStatus(
                              _animeStatus.value,
                              isManga: widget.type == ItemType.manga,
                            ),
                            size: 13,
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    AnymeXText(widget.reasons!.length == 1
                          ? 'View recommendation'
        ...
        children: [
          ...
          if (overflows || _synopsisExpanded) ...[
            ...
            GestureDetector(
              ...
              child: AnymeXText(_synopsisExpanded ? 'Show Less' : 'Read More',
                size: 12,
                color: colors.primary,
                variant: TextVariant.semiBold,
              ),
  ...
  Widget _chip(String label, Color bg, Color fg, {VoidCallback? onTap}) {
    final chip = Container(
      ...
      child: AnymeXText(label, size: 12, color: fg, variant: TextVariant.semiBold),
    );
      ...
      child: Column(
        ...
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (hasValidProfile)
                      ...
                      AnymeXText(widget.author ?? 'Unknown',
                        variant: TextVariant.semiBold,
                        size: 14,
                        color: colors.primary,
                        maxLines: 1,
          ...
          if (widget.reasons != null && widget.reasons!.length > 1) ...[
            const SizedBox(height: 6),
            AnymeXText('+ ${widget.reasons!.length - 1} more recommendation${widget.reasons!.length > 2 ? 's' : ''}',
              size: 11,
              color: colors.onSurfaceVariant,
              variant: TextVariant.regular,
            ),
